		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Raise ticket",
									"targetURL": "#commanishticketmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commanishticketmanagement-display": {
								"semanticObject": "commanishticketmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.manish.ticketmanagement",
									"url": sap.ui.require.toUrl("com/manish/ticketmanagement")
								}
							}
						}
					}
